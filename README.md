...
*▶️ **[Demo video](https://youtu.be/sWc6g7cgsd4)** — the panel played live over the Tiliqua module's four-part Prelude in C, with the synth's own audio (click to watch on YouTube). For sound alone: **[Saint-Saëns · Le Cygne](https://youtu.be/tL7N2eV9pn8)**, 2:18, off a Basys 3; **[Bach · Goldberg Aria](https://youtu.be/UPpt41BPEH8)**, 1:45, and **[Vivaldi · Winter, Largo](https://youtu.be/Qv_raL9kz5I)**, 1:45, both off a Tiliqua. 4 parts each, recorded over USB — no room mic, no software instruments, and the picture is a spectrogram of that same signal. For three modules driven from the one panel: **[multi-board & multipart demo](https://youtube.com/shorts/I3TEsHku3zc)**.*
...
it at that part instead; **⚙ SETTINGS** says which of the two is in force, and it hands the
...
**Where the sound comes out.** The mix lands in whatever your system's default output is, and
**⚙ SETTINGS ▸ Audio out** moves it — headphones, an interface, an HDMI display — without touching the
...
system sound panel, and a name explains more than a disappearance does. The picker needs
...
▶️ **[Three modules, one panel](https://youtube.com/shorts/I3TEsHku3zc)** — what this section
describes, running.
...
> **nextpnr needs `--router router2` here, and it is not a preference.** At 93–99% TRELLIS_COMB the
...
> is load-bearing at this occupancy: a 24-seed sweep of the shipped 24-voice netlist spanned
> 51.60 to **56.63** MHz, and the winners do not transfer between netlists — seed 7 takes that
> 56.63 and read 50.90, near the bottom, on the netlist one commit earlier
...
> measured, not feared — on M37's netlist the dirty variant was 240 cells away, and seed 4 read
> 56.33 MHz on it against 49.12 on the clean one.
